...
def fetch_topic():
    ...
    major, minor = random.sample(random.choice([
        ...
        ["ロミオとジュリエット", "赤ずきん"],
        ["リムジン", "（飛行機の）ファーストクラス"],
        ["半年先まで予約がいっぱいのお店の食事", "一人3万円を超える食事"],
        ["イタリア", "フランス"],
        ["お好み焼き", "たこ焼き"],
        ["初デートで鳥貴族", "１円単位での割り勘"],
        ["昆虫職", "バンジージャンプ"]
